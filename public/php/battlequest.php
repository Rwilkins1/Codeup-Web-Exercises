...
$strength = trim(fgets(STDIN));
$speed = 10 - $strength;

$opening = "Hello, " . $name . "!" . PHP_EOL . "Your strength is: " . $strength . PHP_EOL . "Your speed is: " . $speed . PHP_EOL . "You are about to embark on a grand adventure! When prompted, type in the response you would like to give, not the number of the response. Results labeled 'SCREEEEEEAM!!!!!!' have 6 e's and 6 !'s. Type in 'Start' and press the 'Enter' key to begin!" . PHP_EOL;
...
// Second Question
$question2_1 = "You attempt to get up, but find that you are held down by chains. You exert all your strength into breaking them, but it is of no avail. Suddenly, you hear the voice from before call to you. 'Hello, " . $name . "', it says. How do you respond?" . PHP_EOL . "1) How do you know my name?" . PHP_EOL . "2) Where am I?" . PHP_EOL . "3) Your voice is GAY!" . PHP_EOL . "4) SCREEEEEEAM!!!!!!" . PHP_EOL;
$question2_2 = "'Why the f*** is it so dark?!' You call out. The voice from before responds, 'All is dark to those who do not wish to see, " . $name . ".' How do you respond?" . PHP_EOL . "1) How do you know my name?" . PHP_EOL . "2) Where am I?" . PHP_EOL . "3) What the f*** is that supposed to mean?" . PHP_EOL . "4) SCREEEEEEAM!!!!!!" . PHP_EOL;
$question2_3 = "The voice from before calls out, 'Dude! Why are you screaming?!' How do you respond?" . PHP_EOL . "1) Because I'm chained to the ground, why do you think?" . PHP_EOL . "2) Who are you?" . PHP_EOL . "3) Because I become aroused when I'm chained to the ground" . PHP_EOL . "4) SCREEEEEEAM!!!!!!" . PHP_EOL;

if ($answer1 == "Try to get up") {
	fwrite(STDOUT, $question2_1);
	$answer2 = trim(fgets(STDIN));
} else if ($answer1 == "Call out") {
	fwrite(STDOUT, $question2_2);
	$answer2 = trim(fgets(STDIN));
} else if ($answer1 == "Accept your fate and remain lying down forever") {
	echo "Your Journey Ends" . PHP_EOL;
	die();
} else if ($answer1 == "SCREEEEEEAM!!!!!!") {
...
// Fourth Question
$question4_1 = "'Yes, I can,' the wizard responds, 'but we don't have much time. Will you come with me?'" . PHP_EOL . "1) Yes" . PHP_EOL . "2) No" . PHP_EOL;
...
if ($answer3 == "So you can get me out of here?" || $answer3 == "Twenty years?!" || $answer3 == "Sorry. This is just really scary for me. Can you get me out of here?") {
	fwrite(STDOUT, $question4_1);
	$answer4 = trim(fgets(STDIN));
} else if ($answer3 == "A wizard? You mean, like Gandalf?!" || $answer3 == "You sound like a wizard. *gasp* Are you Gandalf?!") {
	fwrite(STDOUT, $question4_2);
	$answer4 = trim(fgets(STDIN));
} else if ($answer3 == "A wizard? More like a fairy, given how gay you are!" || $answer3 == "GAY!" || $answer3 == "Sorry, my gaydar was going off!") {
...
if($answer6 == "Slash the Wizard" || $answer6 == "Stab the Wizard" || $answer6 == "Shoot the Wizard") {
	fwrite(STDOUT, $question7_1);
	$answer7 = trim(fgets(STDIN));
} else if ($answer6 == "Throw down your sword" || $answer6 == "Throw down your spear" || $answer6 == "Throw down your bow and arrow" || $answer6 == "Put your hands in your pockets") {
	fwrite(STDOUT, $question7_2);
	$answer7 = trim(fgets(STDIN));
} else if ($answer6 == "BEAT THE STUFFINGS OUT OF HIM!" && $strength >= 5) {
	...
	die();
} else if ($answer6 == "Quote Monty Python") {
	...
	die();
} else if ($answer6 == "SCREEEEEEAM!!!!!!" && $speed < 5) {
...
if($answer7 == "Walk to the sound") {
	fwrite(STDOUT, $question8_1);
	$answer8 = trim(fgets(STDIN));
} else if ($answer7 == "Sucker!") {
	fwrite(STDOUT, $question8_2);
	$answer8 == trim(fgets(STDIN));
} else if ($answer7 == "Stay where you are") {
	fwrite(STDOUT, $question8_3);
	$answer8 = trim(fgets(STDIN));
} else if ($answer7 == "I don't want to fight you") {
	...
	die();
} else if ($answer7 == "Because...I love you") {
...
if($answer8 == $name) {
	...
	$answer9 = trim(fgets(STDIN));
} else if ($answer8 == "Yes") {
	fwrite(STDOUT, $question9_2);
	$answer9 = trim(fgets(STDIN));
} else if ($answer8 == "John Jacob Jingleheimer Smith") {
...
if ($answer9 == "Humans") {
	...
	$answer10 = trim(fgets(STDIN));
} else if ($answer9 == "Yes") {
	fwrite(STDOUT, $question10_2);
	$answer10 = trim(fgets(STDIN));
} else if ($answer9 == "Crony Capitalism" || $answer9 == "Umm..." || $answer9 == "I know the answer...but how about you tell me just so I can see if I'm right?") {
...
if ($answer10 == "To escape this dungeon" || $answer10 == "Babes, babes, and more babes") {
	fwrite(STDOUT, $question11_1);
	$answer11 = trim(fgets(STDIN));
} else if ($answer10 == "You, dragon. I love you!") {
	...
	die();
} else if ($answer10 == "A Dire Straights reunion tour") {
...
if ($answer11 == "Fine. I'll comply") {
	fwrite(STDOUT, $question12_1);
	$answer12 = trim(fgets(STDIN));
} else if ($answer11 == "Ask about the homeowner's association") {
	fwrite(STDOUT, $question12_2);
	$answer12 = trim(fgets(STDIN));
} else if ($answer11 == "What? Hell no!") {
	...
	die();
} else if ($answer11 == "Of course I'll comply! I love you!") {
...
if ($answer13 == $strength) {
	...
	die();
} else if ($answer13 == "Not nearly as strong as my love for you") {
	...
	die();
} else if ($answer13 == "Wait! I wasn't paying attention at the beginning!") {
...
if ($answer14 == "Dead") {
	...
	$finalanswer = trim(fgets(STDIN));
} else if ($answer14 == "Alive") {
...
if ($finalanswer == "Become the wizard") {
	echo $ending1;
	die();
} else if ($finalanswer == "Escape the dungeon") {
	echo $ending2;
	die();
} else if ($finalanswer == "Love") {
	echo $ending3;
	die();
} else if ($finalanswer == "Ban books with mature content") {
	echo $ending4;
	die();
} else {
	echo $incorrect;
