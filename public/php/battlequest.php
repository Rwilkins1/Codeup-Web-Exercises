<?php
// "Choose Your Own Adventure" Codeup Challenge
...
if($answer7 == preg_replace('#[^a-zA-Z0-9 ]#', '', strtolower("Walk to the sound"))) {
	...
	echo "'You..you...you do?' The wizard asks with tears evident in his voice. 'Oh, " . $name . ", I had always hoped, but I didn't dare expect it!' You hear a door open in the distance and feel a veiny old hand take your hand. As you and the wizard walk off into the distance, you do not know where you are heading, but you know that, as long as the two of your are together, no adventure, no threat of danger is too daunting." . PHP_EOL;
	sleep(5);
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulations! You go the True Love ending! (Ending 1 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
	sleep(2);
	echo "                            A Game by: Reagan Wilkins                         " . PHP_EOL;
	sleep(2);
	echo "                           Written by: Reagan Wilkins                         " . PHP_EOL;
	sleep(2);
	echo "                          Programmed by: Reagan Wilkins                       " . PHP_EOL;
	sleep(2);
	echo "                              Thanks for Playing!                             " . PHP_EOL;
	sleep(2);
	echo $divider;
	sleep(2);
	echo "Enter the file name to play again!" . PHP_EOL;
	sleep(3);
	die();
...
if ($answer10 == preg_replace('#[^a-zA-Z0-9 ]#', '', strtolower("To escape this dungeon")) || $answer10 == preg_replace('#[^a-zA-Z0-9 ]#', '', strtolower("Babes, babes, and more babes"))) {
	...
	echo "'T..Truly?!' The dragon asks with tears in its eyes. 'Oh, " . $name . ", I always hoped, but I never dared expect it! Hop on my back, and we'll leave this place together.' You hop onto the dragon's mighty back, and you feel the warmth of its body under you. You hold on tight to its spines as it takes off and flies outside of a hole in the ceiling. As you and the dragon fly out into the darkness of the night, you do not know what fate has in store, what adventures and dangers await you outside of the dungeon walls. But you know that, as long as the two of you are together, no adventure, no threat of danger is too daunting." . PHP_EOL;
	sleep(5);
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulations! You go the True (if unconventional) Love ending! (Ending 2 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
	...
	echo "You decide that, even though the exit is right in front of you, you are more than content to stay in your dark little dungeon. After all, your dark little dungeon protects you, and without your dark little dungeon, who would build the roads?" . PHP_EOL;
	sleep(5);
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulations! You go the Metaphor for Statism ending! (Ending 3 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
...
if ($answer12 == preg_replace('#[^a-zA-Z0-9 ]#', '', strtolower("Yes"))) {
	...
	echo "'Very well!' The woman says. 'You now own all of the real estate in Devonstormholdshire! I and every citizen here are now at your disposal...master.'" . PHP_EOL;
	sleep(5);
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulations! You go the Opportunist ending! (Ending 5 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
...
if ($answer13 == $strength) {
	...
	echo "The sage shakes his head. 'There are many True Love endings for this game,' he starts, 'however, I am not one of them.' Knowing that the sage will never love you, you walk back to the cell in which you started. As you stare into the dark abyss of your cell, you realize that even the smallest adventures, even the smallest threats of danger are too daunting to bear" . PHP_EOL;
	echo $ending3;
	sleep(5);
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulations! You go the Forever Alone ending! (Ending 6 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
...
if ($finalanswer == preg_replace('#[^a-zA-Z0-9 ]#', '', strtolower("Become the wizard"))) {
	echo $ending1;
	sleep(5);
	echo "'I did it,' you say." . PHP_EOL;
	sleep(3);
	echo "The End" . PHP_EOL;
	sleep(2);
	echo "Congratulations! You got the Hero ending! (Ending 7 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
	...
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulations! You go tthe Villain ending! (Ending 8 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
	...
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulations! You go the True (plural) Love ending! (Ending 9 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
	...
	echo "The End" . PHP_EOL;
	sleep(3);
	echo "Congratulation! You got the Soccer Mom ending! (Ending 10 out of 10!)" . PHP_EOL;
	sleep(5);
	echo $divider;
	sleep(2);
	echo "                                 Battle Quest                                 " . PHP_EOL;
